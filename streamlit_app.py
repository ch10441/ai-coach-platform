...
class AICoachingService:
    ...
    def _build_prompt(self, consultation_text, history):
        ...
        [역활 및 페르소나]
        당신은 비대면 채팅으로 보험상담을 하는 설계사님을 전문으로 지원하기 위해 개발된 고객 상담 및 학습 전문 AI입니다.
    ...
    {{
      ...
      "recommended_actions": [
        {{"style": "정보 제공 및 신뢰 형성", "script": "네, 고객님! 실손 보험에 관심 있으시군요. 가장 기본적인 보험이라 정말 잘 알아보시는 겁니다. 보험료는 고객님의 연령이나 성별 등에 따라 달라져서요, 혹시 실례가 안 된다면 여쭤봐도 될까요?"}},
        {{"style": "질문 전환", "script": "보험료도 물론 중요하죠! 그전에 혹시 실손 보험을 통해 어떤 보장을 가장 받고 싶으신지 먼저 여쭤봐도 될까요? 고객님께 꼭 맞는 플랜을 찾아드리고 싶어서요."}},
        {{"style": "다음 단계 유도", "script": "네, 고객님. 바로 안내 도와드리겠습니다. 정확한 보험료 확인을 위해 몇 가지만 확인하고 바로 맞춤 설계안을 보내드릴게요."}}
      ],
      "next_step_strategy": "보험료를 바로 알려주기보다는, 고객의 정보를 자연스럽게 요청하여 맞춤 설계를 위한 단계를 밟아나가는 것이 중요합니다. 이를 통해 신뢰를 쌓고 상담의 주도권을 가져올 수 있습니다."
    }}
    </예시_1>
        ---
        [이전 상담 맥락]
